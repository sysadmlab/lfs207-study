...
**HISTFILESIZE** is the maximum number of items the history file can accommodate. From the image above, I note that Ubuntu has a bigger **HISTFILESIZE** than Rocky Linux and openSUSE Leap.
