...
By default, the files (hidden files) in the **SKEL** directory (Skeleton directory) and copied to the user's home folder. Images below show the SKEL directories of Ubuntu and Rocky Linux. </br>  
...
<img width="611" height="212" alt="Screenshot From 2026-09-18 20-14-28" src="https://github.com/user-attachments/assets/42abf745-727c-4d26-9b23-a3deeb04e42e" />  
